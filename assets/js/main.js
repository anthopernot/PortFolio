...
const data = [
    ...
    { id: 25, title: "CrazyCharlyDay", description:"IUT Nancy C. Competition - Management Site for La Grande Épicerie", type:'webapp', langage:'JS, PHP, HTML, CSS', tech:'Slim 4, Twig, PHPMailer, ORM Eloquent, Boostrap, PHPDotenv, Slim/CSRF', url: 'https://jules-sayer.com/projects/ccd', urlGit:'https://github.com/anthopernot/CrazyCharlyDay', img: 'assets/img/custom/custom_firename.jpg'},
